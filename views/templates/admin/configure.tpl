...
<div class="panel">
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item active">
            <a class="nav-link" data-toggle="tab" href="#tab-cms-pages" role="tab">
                <i class="icon-file-text"></i> {l s='CMS Pages' d='Modules.Tasmimconsentpolicymanager.Admin'}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#tab-cookie-consent" role="tab">
                <i class="icon-lock"></i> {l s='Cookie Consent' d='Modules.Tasmimconsentpolicymanager.Admin'}
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" data-toggle="tab" href="#tab-gdpr-settings" role="tab">
                <i class="icon-shield"></i> {l s='GDPR & Settings' d='Modules.Tasmimconsentpolicymanager.Admin'}
            </a>
        </li>
    </ul>
    ...
    <div class="tab-content" style="padding-top: 20px;">
        {* ==================== TAB 1: CMS Pages ==================== *}
        <div class="tab-pane active" id="tab-cms-pages" role="tabpanel">

            {* Active Languages *}
            <div class="form-group">
                <h4><i class="icon-globe"></i> {l s='Active Languages' d='Modules.Tasmimconsentpolicymanager.Admin'}</h4>
                <table class="table">
                    <thead>
                        <tr>
            ...
            {* CMS Pages Status *}
            <h4><i class="icon-list"></i> {l s='CMS Pages Status' d='Modules.Tasmimconsentpolicymanager.Admin'}</h4>
        ...
        <div class="tab-pane" id="tab-cookie-consent" role="tabpanel">
        ...
        {* ==================== TAB 3: GDPR & Settings ==================== *}
        <div class="tab-pane" id="tab-gdpr-settings" role="tabpanel">

            {* GDPR Consent Messages *}
            <h4><i class="icon-shield"></i> {l s='GDPR Consent Messages' d='Modules.Tasmimconsentpolicymanager.Admin'}</h4>
            ...
            {else}
                ...
                <form method="post" action="{$configure_link}" style="margin-top: 15px;">
